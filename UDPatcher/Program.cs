...
namespace UDPatcher
{
    public class Settings
    {
        ...
        public List<ModKey> ModsToPatch = new List<ModKey>();
    }
    public class Program
    {
        ...
        public static async Task<int> Main(string[] args)
        {
            return await SynthesisPipeline.Instance
                ...
                .SetAutogeneratedSettings(
                            ...
                            path: "settings.json",
                            out Settings)
                .SetTypicalOpen(GameRelease.SkyrimSE, Settings.Value.OutputPatchName)
                .Run(args);
        }
        ...
        public static void RunPatch(IPatcherState<ISkyrimMod, ISkyrimModGetter> state)
        {
            ...
            int totalPatched = 0;
            int newDevices = 0;
            foreach (var invArmorGetter in state.LoadOrder.PriorityOrder.Where(mod => Settings.Value.ModsToPatch.Contains(mod.ModKey)).Armor().WinningOverrides())
            {
